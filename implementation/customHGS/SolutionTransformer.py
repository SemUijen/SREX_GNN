...
class SolutionTransformer:
    ...
    def get_instance(instance_name: str) -> ProblemData:
        if  instance_name in ["R2_8_9", 'R1_4_10']:
            instance = read(f"C:/SREX_GNN/data/routes/{instance_name}.vrp", round_func='round', instance_format="solomon")

        else:
            instance = read(f"C:/SREX_GNN/data/routes/{instance_name}.vrp", round_func='round')
    ...
    def __call__(self, instance: ProblemData, get_full_graph: bool, parent_solution: Solution = None):
