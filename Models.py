...
class SREXmodel(nn.Module):
    ...
    def __init__(self, num_node_features: int, hidden_dim: int, max_routes_to_swap: int, num_heads:int, dropout: float):
        ...
        self.route_combination_head = nn.Linear(2 * self.hidden_dim, self.max_routes_to_swap + 1)
    ...
    def fix_later(self):
        ...
        ## Parent 1
        P1_Cnode_to_route = torch.tensor(parent1_data.Cnode_Rnode_vector)
        ...
        ## Parent 2
        P2_Cnode_to_route = torch.tensor(parent2_data.Cnode_Rnode_vector)
