...
class SolutionTransformer:
    ...
    def solution_to_input(self, instance: ProblemData, solution: Solution):
        ...
        client_features, client_demand, client_pos, depot_pos = self.get_node_features(
            instance
        )
    ...
    def __call__(
        ...
        if get_full_graph:
            ...
            if parent_solution:
                # instance = self.get_instance(instance_name=ProblemData)
